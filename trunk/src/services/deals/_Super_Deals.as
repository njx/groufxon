 ...
 * of this service wrapper you may modify the generated sub-class of this class - Deals.as.
 */
package services.deals
{
...
[ExcludeClass]
internal class _Super_Deals extends com.adobe.fiber.services.wrapper.HTTPServiceWrapper
{
    ...
    public function _Super_Deals()
    {
        ...
        _serviceControl = new mx.rpc.http.HTTPMultiService();
         ...
         operation.properties["xPath"] = "/::deals/::deal";
         operation.resultElementType = valueObjects.Deal;
    ...
    /**
      ...
      */
    public function getData(client_id:String, lat:String, lng:String, radius:String, show:String) : mx.rpc.AsyncToken
    {
